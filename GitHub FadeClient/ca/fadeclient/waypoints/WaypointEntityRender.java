package ca.fadeclient.waypoints;
...
/*public class WaypointEntityRender extends Render {
   ...
   public void doRender(Entity entity, double d, double d1, double d2, float f, float f1) {
      ...
      if(rm.getMarker()) {
         ...
         if(!list.isEmpty()) {
            ...
            GL11.glDisable(2896);
            GL11.glDisable(2912);
            int func11 = GL11.glGetInteger(3009);
            float ref1 = GL11.glGetFloat(3010);
   ...
   private class ViewWaypoint extends Waypoint implements Comparable {
