...
public class ClientMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public ClientMultiplayer(GuiScreen parentScreen)
    {
    ...
    {
        this.buttonList.add(this.btnEditServer = new ClientMainMenuButton(7, this.width / 2 - 154, this.height - 28, 70, 20, new Color(23, 23, 46).getRGB(), new Color(255, 255, 255).getRGB(), I18n.format("selectServer.edit", new Object[0])));
        this.buttonList.add(this.btnDeleteServer = new ClientMainMenuButton(2, this.width / 2 - 74, this.height - 28, 70, 20, new Color(23, 23, 46).getRGB(), new Color(255, 255, 255).getRGB(), I18n.format("selectServer.delete", new Object[0])));
        this.buttonList.add(this.btnSelectServer = new ClientMainMenuButton(1, this.width / 2 - 154, this.height - 52, 100, 20, new Color(23, 23, 46).getRGB(), new Color(255, 255, 255).getRGB(), I18n.format("selectServer.select", new Object[0])));
        this.buttonList.add(new ClientMainMenuButton(4, this.width / 2 - 50, this.height - 52, 100, 20, new Color(23, 23, 46).getRGB(), new Color(255, 255, 255).getRGB(), I18n.format("selectServer.direct", new Object[0])));
        this.buttonList.add(new ClientMainMenuButton(3, this.width / 2 + 4 + 50, this.height - 52, 100, 20, new Color(23, 23, 46).getRGB(), new Color(255, 255, 255).getRGB(), I18n.format("selectServer.add", new Object[0])));
        this.buttonList.add(new ClientMainMenuButton(8, this.width / 2 + 4, this.height - 28, 70, 20, new Color(23, 23, 46).getRGB(), new Color(255, 255, 255).getRGB(), I18n.format("selectServer.refresh", new Object[0])));
        this.buttonList.add(new ClientMainMenuButton(0, this.width / 2 + 4 + 76, this.height - 28, 75, 20, new Color(23, 23, 46).getRGB(), new Color(255, 255, 255).getRGB(), I18n.format("gui.cancel", new Object[0])));
